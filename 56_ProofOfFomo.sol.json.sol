...
function () external payable isRound9(){
if (true) {
}
 else {
}
...
function pledge() external payable isRound9(){
if (true) {
}
 else {
}
...
function gift(address   _to) external payable isRound9(){
if (true) {
}
 else {
}
...
function loot() external  round9Ended(){
if (true) {
}
 else {
}
...
function lock(address   _player) private  {
if (true) {
}
 else {
}
...
function unlock() external  isRound9(){
if (true) {
}
 else {
}
...
function getEtherSpentInRound(address   _player) private  returns (uint256   ) {
if (true) {
}
 else {
}
