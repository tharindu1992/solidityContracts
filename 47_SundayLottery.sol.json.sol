...
return uint(keccak256(abi.encodePacked(blockhash(blockn ) ,entropy ) ) );
}
...
function getCountWinnersDistrib() public view returns (uint   countWinRound_1, uint   countWinRound_2, uint   countWinRound_3, uint   countWinRound_4, uint   countWinRound_5) {
if (true) {
}
 else {
}
(countWinRound_1, countWinRound_2, countWinRound_3, countWinRound_4, countWinRound_5) = m_tickets.getCountWinnersDistrib(currentRound );
}
function getPayEachWinnersDistrib() public view returns (uint   payEachWin_1, uint   payEachWin_2, uint   payEachWin_3, uint   payEachWin_4, uint   payEachWin_5) {
if (true) {
}
 else {
}
(payEachWin_1, payEachWin_2, payEachWin_3, payEachWin_4, payEachWin_5) = m_tickets.getPayEachWinnersDistrib(currentRound );
}
...
(countWinnerRound_1, countWinnerRound_2, countWinnerRound_3, countWinnerRound_4, countWinnerRound_5) = getCountWinnersDistrib();
}
...
(payEachWinner_1, payEachWinner_2, payEachWinner_3, payEachWinner_4, payEachWinner_5) = getPayEachWinnersDistrib();
}
